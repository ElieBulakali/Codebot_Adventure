    ...
    <div className={`min-h-screen ${bgClass} p-4`}>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className={`${darkMode ? 'bg-gray-800 text-white' : 'bg-white text-gray-900'} rounded-2xl p-6 max-w-md w-full`}>
            ...
            <div className="mb-6">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`flex-1 px-4 py-2 rounded-lg ${musicOn ? 'bg-purple-500 text-white' : darkMode ? 'bg-gray-700' : 'bg-gray-200'}`}
                >
                  ON
                </button>
                <button
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-blue-500 hover:bg-blue-600 text-white rounded-lg font-bold"
            >
              <HelpCircle size={20} />
              {t.help}
            </button>
      ...
      {showHelp && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 overflow-y-auto">
          <div className={`${darkMode ? 'bg-gray-800 text-white' : 'bg-white text-gray-900'} rounded-2xl p-6 max-w-2xl w-full my-8`}>
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold flex items-center gap-2">
                <HelpCircle size={28} className="text-blue-400" />
                {helpContent[language].title}
              </h2>
              <button onClick={() => setShowHelp(false)} className={`p-2 ${darkMode ? 'hover:bg-gray-700' : 'hover:bg-gray-200'} rounded-lg`}>
                <X size={24} />
              </button>
            </div>

            <p className={`mb-6 text-lg ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
              {helpContent[language].description}
            </p>

            {helpContent[language].sections.map((section, idx) => (
              <div key={idx} className={`mb-6 p-4 ${darkMode ? 'bg-gray-700' : 'bg-gray-100'} rounded-lg`}>
            ...
            <button
              ...
              className="w-full px-4 py-3 bg-purple-500 hover:bg-purple-600 text-white rounded-lg font-bold"
            >
              {t.close}
            </button>
          </div>
